...
type ServiceClient interface {
	Get(ctx context.Context, in *Key, opts ...grpc.CallOption) (*Access, error)
}
...
type ServiceServer interface {
	Get(context.Context, *Key) (*Access, error)
...
func (UnimplementedServiceServer) Get(context.Context, *Key) (*Access, error) {
