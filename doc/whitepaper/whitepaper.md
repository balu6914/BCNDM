...
abstract: |
  ...
  **A global-scale marketplace for IoT sensor data is need. This marketplace is called Monetasa**.
...
# Introduction
Monetasa is marketplace for IoT sensor data. But beyond IoT, Monetasa marketplace
...
## Implementation
Monetasa sensors are attached to Monetasa gateways[^gw] and edge computers, or directly connected to the IoT platform.
...
[^gw]: Current Monetasa IoT gateway implementation is based on novel EdgeX Foundry architecture. EdgeX Foundry is a vendor-neutral open source project building a common open framework for IoT edge computing. At the heart of the project is an interoperability framework hosted within a full hardware- and OS-agnostic reference software platform to enable an ecosystem of plug-and-play components that unifies the marketplace and accelerates the deployment of IoT solutions. More information can be obtained at project's web address: <https://www.edgexfoundry.org/>.
